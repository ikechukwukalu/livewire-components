        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('get-mails') }}">{{ __('Get Mails') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('infinite-scroll') }}">{{ __('Infinite Scroll') }}</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ route('sortable-basic') }}">
                                {{ __('Basic') }}
                            </a>
                            <a class="dropdown-item" href="{{ route('sortable-complex') }}">
                                {{ __('Complex') }}
                            </a>
                        </div>
                    </li>
