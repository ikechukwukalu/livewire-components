...
class searchEmailCacheNextPage implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct(string $cache, int $page, int $take, int $cacheTime, array $commonFolders, string $root, string $email, string $text)
    {
        //
        $this->cache = $cache;
        $this->page = $page;
