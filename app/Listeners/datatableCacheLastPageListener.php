...
class datatableCacheLastPageListener implements ShouldQueue
{
    /**
    ...
    public function shouldQueue(datatableEvent $event)
    {
        ...
        datatableCacheLastPage::dispatchIf(!Cache::has($cache), $event->cache, $event->last_page, $event->simplePaginate, $event->order_by, $event->cache_time, $event->white_list);
    }
}
